...
class MainViewModel : ViewModel() {
    ...
    fun executeDataChanged(endpoint: String, appId: String, userToken: String, secretKey: String, challengeId: String) {
        if (endpoint.isBlank()) {
            ...
            _executeForm.value = ExecuteFormState(secretKeyError = R.string.invalid_secret_key)
